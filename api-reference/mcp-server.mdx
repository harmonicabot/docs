...
If you use Claude Code, you can also install the [harmonica-chat](https://github.com/zhiganov/harmonica-chat) slash command for quick session creation:

```bash
curl -fsSL https://raw.githubusercontent.com/zhiganov/harmonica-chat/main/install.sh | bash
```

Then create sessions with `/create-session "Topic" --goal "Goal"`.
