...
<Steps>
  ...
  <Step title="Refine your session">
    After completing the form, Harmonica will generate a conversational guide (prompt) for the AI assistant. You can:
...
This helps the AI assistant know what to focus on during conversations with participants.
...
The link takes participants directly to the chat interface where they can start their conversation with the AI assistant.
