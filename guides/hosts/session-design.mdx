...
<Note>
  HARMONICA.md is shown as a read-only accordion so you can see what organizational context the facilitator is inheriting. To change it, go to **Settings → Context**. See [Organizational context](/guides/hosts/organizational-context).
</Note>
