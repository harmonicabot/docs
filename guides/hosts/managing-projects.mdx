...
## Project memory (HARMONICA.md)

Every project benefits from shared organizational context. Harmonica reads your HARMONICA.md — a short markdown document describing your team, vocabulary, and working norms — and injects it into every new session you create. It means the AI facilitator arrives already knowing who you are, without you copy-pasting a brief each time.

<CardGroup cols={1}>
  <Card title="Set up project memory" icon="file-text" href="/guides/hosts/project-memory">
...
<CardGroup cols={2}>
  ...
  <Card title="Project memory" icon="file-text" href="/guides/hosts/project-memory">
    Set up organizational context for all your sessions
  </Card>
