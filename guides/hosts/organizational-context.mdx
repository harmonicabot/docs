...
description: "Give every session you create a shared organizational context so the facilitator sounds like you"
---

## What is HARMONICA.md?

HARMONICA.md is a short markdown document that describes your organization, team, or community to Harmonica. It is scoped to **you as a host** — once set, it is injected into the facilitation prompt of every new session you create, so the AI facilitator arrives already knowing your vocabulary, your decision-making norms, and the context that would otherwise take a paragraph of copy-paste each time.
