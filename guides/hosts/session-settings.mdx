...
Every change to the facilitation prompt and summary prompt is tracked. Open the **History** button next to either prompt in Session Design to see a timestamped log of edits — including who made each change and what triggered it (a manual edit, a template switch, a brief-field cascade, or a Review-tab suggestion you applied).
